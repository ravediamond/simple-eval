...
class EvaluationPDFGenerator:
    ...
    def generate_pdf(self, results: List[Any], insights: Dict[str, Any], filename: str, evaluation_time: str, language: str = 'en') -> io.BytesIO:
        ...
        story.append(Paragraph("🚀 Generated by EvalNow", self.styles['FooterBrand']))
        story.append(Paragraph('<link href="https://evalnow.xyz">evalnow.xyz</link>', self.styles['FooterURL']))
